...
guppyBin=/home/pthorpe/projects/Janet_Cox_Singh/Sulawesi_Macaque/ont-guppy/bin/
...
# this one seems to have a diff structure :(
...
do
    cmd="$guppyBin/guppy_basecaller \
    -i ~/projects/Janet_Cox_Singh/Sulawesi_Macaque/MRC1123_WuH001WB/WuH001WB/20230120_1237_MC-114095_FAU91423_b6958351/fast5 \
    -s $outputFolder/MRC1123_WuH001WB \
    --device auto \
    --flowcell $flowcellVersion \
    --kit $sequencingKit \
     --compress_fastq  --device auto"
